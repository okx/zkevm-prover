...
#pragma omp parallel for
    ...
    writeArrayToFile("runtime/output/p_cm3_n.bin", (uint64_t *)p_cm3_n, N * starkInfo.mapSectionsN.section[eSection::cm3_n]);

    ntt.extendPol(p_cm3_2ns, p_cm3_n, NExtended, N, starkInfo.mapSectionsN.section[eSection::cm3_n], pBuffer);

    //writeArrayToFile("runtime/output/p_cm3_2ns.bin", (uint64_t *)p_cm3_2ns, NExtended * starkInfo.mapSectionsN.section[eSection::cm3_n]);
