...
int Fr_isTrue(PFrElement pE){return 0;}
int Fr_toInt(PFrElement pE){return 0;}
...
int Fr_rawIsEq(const FrRawElement pRawA, const FrRawElement pRawB){return 0;}
int Fr_rawIsZero(const FrRawElement pRawB){return 0;}
#endif
